...
The Sons Of Odin Mod Pack is a **non-commercial** convenience bundle. Every mod
below belongs to its original author and is redistributed here **only to make
joining the server easier** — it is never sold. All credit goes to the creators.

If you enjoy these mods, please support the authors on their official pages
(Thunderstore / Nexus / GitHub) and consider donating to them directly.
...
| Longship Upgrades | 1.0.18 | shudnal | https://thunderstore.io/c/valheim/p/shudnal/LongshipUpgrades/ |
...
| Better Ladders | 0.2.0 | see Thunderstore | https://thunderstore.io/c/valheim/ |
| Speedy Paths | 1.0.8 | see Thunderstore | https://thunderstore.io/c/valheim/ |
| Minimal Status Effects | 1.0.7 | see Thunderstore | https://thunderstore.io/c/valheim/ |

## Mod loader

| Component | Version | Author | Source |
|---|---|---|---|
| BepInExPack Valheim | 5.4.2350 | denikson / BepInEx Team | https://thunderstore.io/c/valheim/p/denikson/BepInExPack_Valheim/ |

## Note to mod authors

If you are the author of any mod bundled here and would like it removed or
credited differently, please open an issue on this repository and it will be
handled promptly.
